...
function RecipeCard(props){
    const {img_url, rec_name, restrictions, cooking_time, ingredients, showHide, clickFunc} = props; //Removes repetitive code(i.e. !props.img_url, just img_url).
    
    return (
        <>
            <article className={`pop-up ${showHide}`}>
                <section className='pop-rec'>
                    ...
                    <button onClick={clickFunc} className='back-btn'>Back To Recipes</button>
                </section>
            </article>
        </>
    );
